...
class AdaptiveQuizQuestionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $questions = [
            ...
            ['q' => 'What should you do if you find matches or a lighter lying around?', 'o' => ['Leave them and tell an adult', 'Put them in a drawer', 'Take them to school'], 'a' => 0, 'd' => 'Easy', 'c' => 'Final Exam', 'e' => 'Never touch matches or lighters. Tell an adult right away!'],
            ['q' => 'If your clothes catch on fire, what should you do?', 'o' => ['Stop, Drop, and Roll', 'Run to find water', 'Wave a towel over them'], 'a' => 0, 'd' => 'Easy', 'c' => 'Final Exam', 'e' => 'Stop, Drop, and Roll puts out the fire on your clothes!'],
            ['q' => 'Why should you stay with your teacher during a fire drill?', 'o' => ['So everyone is safely counted', 'To help lead the line', 'To guard the classroom door'], 'a' => 0, 'd' => 'Easy', 'c' => 'Final Exam', 'e' => 'Staying with your class makes sure everyone gets out safely!'],
            ['q' => 'What is the main job of a smoke alarm?', 'o' => ['To detect smoke early', 'To measure room temperature', 'To improve air quality'], 'a' => 0, 'd' => 'Easy', 'c' => 'Final Exam', 'e' => 'Smoke alarms beep loudly to warn you early so you can escape!'],
            ['q' => 'Where is the best place to put a smoke alarm?', 'o' => ['High on the ceiling', 'Near the floor level', 'Inside the closet'], 'a' => 0, 'd' => 'Easy', 'c' => 'Final Exam', 'e' => 'Smoke rises up into the air, so alarms must be placed up high!'],
            ...
            ['q' => 'If you see a lighter on a table, why tell an adult?', 'o' => ['It can easily spark a fire', 'It might run out of fluid', 'It should be stored outside'], 'a' => 0, 'd' => 'Medium', 'c' => 'Final Exam', 'e' => 'Lighters are tools for adults, not toys for kids!'],
            ['q' => 'In \'Stop, Drop, and Roll\', why cover your face with hands?', 'o' => ['To protect your eyes and lungs', 'To help you roll faster', 'To keep smoke off your clothes'], 'a' => 0, 'd' => 'Medium', 'c' => 'Final Exam', 'e' => 'Covering your face keeps your eyes, nose, and mouth safe from heat!'],
            ['q' => 'Why is wandering away from your class during a drill dangerous?', 'o' => ['Firefighters might search for you', 'You could block the doorway', 'The alarm might stop ringing'], 'a' => 0, 'd' => 'Medium', 'c' => 'Final Exam', 'e' => 'If you wander off, firefighters might think you are trapped inside!'],
            ['q' => 'How does a smoke alarm protect you while sleeping?', 'o' => ['Senses smoke and beeps loudly', 'Filters smoke from the air', 'Calls the fire station automatically'], 'a' => 0, 'd' => 'Medium', 'c' => 'Final Exam', 'e' => 'A smoke alarm works all night long to warn you even when you are asleep!'],
            ['q' => 'Why put smoke alarms on the ceiling instead of the floor?', 'o' => ['Because hot smoke rises up', 'To keep them away from windows', 'Because floor air is too cool'], 'a' => 0, 'd' => 'Medium', 'c' => 'Final Exam', 'e' => 'Since hot smoke rises, alarms on the ceiling catch the smoke fastest!'],
            ...
            ['q' => 'Why must you never try to pick up a lighter?', 'o' => ['You could accidentally spark a flame', 'It might damage the fuel valve', 'It can leak flammable gas'], 'a' => 0, 'd' => 'Hard', 'c' => 'Final Exam', 'e' => 'Even a tiny spark can start a dangerous fire. Let an adult handle it!'],
            ['q' => 'Why does running make a fire on your clothes burn faster?', 'o' => ['Running feeds oxygen to flames', 'Running spreads sparks around', 'Running increases body heat'], 'a' => 0, 'd' => 'Hard', 'c' => 'Final Exam', 'e' => 'Fire loves oxygen! Running feeds the fire more air, while rolling smothers it!'],
            ['q' => 'Why do firefighters need teachers to take a strict headcount?', 'o' => ['To verify no one is trapped', 'To record fire drill times', 'To check for missing belongings'], 'a' => 0, 'd' => 'Hard', 'c' => 'Final Exam', 'e' => 'A fast headcount lets firefighters know if anyone is still inside!'],
            ['q' => 'What makes a smoke alarm sound its warning beep?', 'o' => ['Sensors that detect smoke particles', 'Heat moving across the ceiling', 'A change in air pressure'], 'a' => 0, 'd' => 'Hard', 'c' => 'Final Exam', 'e' => 'Smart sensors detect smoke in the air and trigger the loud beep!'],
            ['q' => 'Why not put a smoke alarm near the shower or stove?', 'o' => ['Steam can trigger false alarms', 'Moisture can rust the battery', 'Airflow is too fast there'], 'a' => 0, 'd' => 'Hard', 'c' => 'Final Exam', 'e' => 'Steam from hot showers or cooking can set off false alarms by mistake!'],
